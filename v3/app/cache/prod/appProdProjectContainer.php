...
class appProdProjectContainer extends Container
{
    ...
    protected function getBroadway_CommandHandling_SimpleCommandBusService()
    {
        ...
        $instance->subscribe($this->get('hangman.game.handler'));
        return $instance;
    }
    ...
    {
        return $this->services['broadway.saga.state.mongodb_database'] = $this->get('broadway.saga.state.mongodb_connection')->selectDatabase('broadway_prod_prod');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'hangmanv3', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('/vagrant/src/Hangman/Bundle/Game/Infrastructure/Doctrine' => 'Hangman\\Bundle'));
        $a->setGlobalBasename('mapping');
        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Hangman\\Bundle');
        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('HangmanApplication' => 'Hangman\\Bundle'));
    ...
    protected function getHangman_Game_ControllerService()
    {
        return $this->services['hangman.game.controller'] = new \Hangman\Bundle\Controller\GameController($this->get('broadway.command_handling.simple_command_bus'), $this->get('broadway.uuid.generator'), $this->get('form.factory'), $this->get('router'), $this->get('hangman.game.read_model_repository'));
    }
    protected function getHangman_Game_HandlerService()
    {
        return $this->services['hangman.game.handler'] = new \Hangman\Bundle\Game\Application\GameCommandHandler($this->get('hangman.event.repo'));
    }
    protected function getHangman_Game_ProjectorService()
    {
        return $this->services['hangman.game.projector'] = new \Hangman\Bundle\Game\ReadModel\GameProjector($this->get('hangman.game.read_model_repository'));
    }
    ...
    {
        return $this->services['simgroep.event_sourcing.command.factory'] = new \Simgroep\EventSourcing\CommandHandling\CommandFactory($this->get('simgroep.event_sourcing.command.container'), $this->get('validator'));
    }
    ...
    {
        return $this->services['simgroep_event_sourcing.repository.lock_manager'] = new \Simgroep\EventSourcing\Repository\PessimisticLockManager(new \NinjaMutex\Lock\MySqlLock('root', 'root', 'localhost'));
    }
