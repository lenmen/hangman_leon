...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'broadway.command_handling.simple_command_bus' => 'getBroadway_CommandHandling_SimpleCommandBusService',
            'broadway.elasticsearch.client' => 'getBroadway_Elasticsearch_ClientService',
            'broadway.event_dispatcher' => 'getBroadway_EventDispatcherService',
            'broadway.event_handling.event_bus' => 'getBroadway_EventHandling_EventBusService',
            'broadway.event_store.dbal' => 'getBroadway_EventStore_DbalService',
            'broadway.event_store.in_memory' => 'getBroadway_EventStore_InMemoryService',
            'broadway.metadata_enricher.console' => 'getBroadway_MetadataEnricher_ConsoleService',
            'broadway.metadata_enriching_event_stream_decorator' => 'getBroadway_MetadataEnrichingEventStreamDecoratorService',
            'broadway.read_model.elasticsearch.repository_factory' => 'getBroadway_ReadModel_Elasticsearch_RepositoryFactoryService',
            'broadway.saga.metadata.factory' => 'getBroadway_Saga_Metadata_FactoryService',
            'broadway.saga.metadata_enricher' => 'getBroadway_Saga_MetadataEnricherService',
            'broadway.saga.multiple_saga_manager' => 'getBroadway_Saga_MultipleSagaManagerService',
            'broadway.saga.state.mongodb_collection' => 'getBroadway_Saga_State_MongodbCollectionService',
            'broadway.saga.state.mongodb_connection' => 'getBroadway_Saga_State_MongodbConnectionService',
            'broadway.saga.state.mongodb_database' => 'getBroadway_Saga_State_MongodbDatabaseService',
            'broadway.saga.state.mongodb_repository' => 'getBroadway_Saga_State_MongodbRepositoryService',
            'broadway.saga.state.state_manager' => 'getBroadway_Saga_State_StateManagerService',
            ...
            'hangman.controller.command_handler' => 'getHangman_Controller_CommandHandlerService',
            'hangman.controller.game' => 'getHangman_Controller_GameService',
            'hangman.controller.games_statics' => 'getHangman_Controller_GamesStaticsService',
            'hangman.read_model.projector.game' => 'getHangman_ReadModel_Projector_GameService',
            'hangman.read_model.projector.game_statics' => 'getHangman_ReadModel_Projector_GameStaticsService',
            'hangman.read_model_game_repository' => 'getHangman_ReadModelGameRepositoryService',
            'hangman.read_model_game_statics_repository' => 'getHangman_ReadModelGameStaticsRepositoryService',
            'hangman.repository.game' => 'getHangman_Repository_GameService',
            'hangman.services.messages' => 'getHangman_Services_MessagesService',
            ...
            'sim.event_store.replay' => 'getSim_EventStore_ReplayService',
            'sim.projector.registry' => 'getSim_Projector_RegistryService',
            'sim.read_model.repository.game' => 'getSim_ReadModel_Repository_GameService',
            'simgroep.event_sourcing.command.container' => 'getSimgroep_EventSourcing_Command_ContainerService',
            'simgroep.event_sourcing.command.factory' => 'getSimgroep_EventSourcing_Command_FactoryService',
            'simgroep.event_sourcing.command.locator' => 'getSimgroep_EventSourcing_Command_LocatorService',
            'simgroep_event_sourcing.command_gateway' => 'getSimgroepEventSourcing_CommandGatewayService',
            'simgroep_event_sourcing.command_gateway.scheduler' => 'getSimgroepEventSourcing_CommandGateway_SchedulerService',
            'simgroep_event_sourcing.event_loop_consumer' => 'getSimgroepEventSourcing_EventLoopConsumerService',
            'simgroep_event_sourcing.event_loop_publisher' => 'getSimgroepEventSourcing_EventLoopPublisherService',
            'simgroep_event_sourcing.locking_repository_factory' => 'getSimgroepEventSourcing_LockingRepositoryFactoryService',
            'simgroep_event_sourcing.messaging.consumer_channel_factory' => 'getSimgroepEventSourcing_Messaging_ConsumerChannelFactoryService',
            'simgroep_event_sourcing.messaging.consumer_factory' => 'getSimgroepEventSourcing_Messaging_ConsumerFactoryService',
            'simgroep_event_sourcing.messaging.publisher_channel_factory' => 'getSimgroepEventSourcing_Messaging_PublisherChannelFactoryService',
            'simgroep_event_sourcing.messaging.publisher_factory' => 'getSimgroepEventSourcing_Messaging_PublisherFactoryService',
            'simgroep_event_sourcing.repository.lock_manager' => 'getSimgroepEventSourcing_Repository_LockManagerService',
            'simgroep_event_sourcing.serializer.domain_event_stream' => 'getSimgroepEventSourcing_Serializer_DomainEventStreamService',
            'simgroep_event_sourcing.serializer.domain_message' => 'getSimgroepEventSourcing_Serializer_DomainMessageService',
            'spray_serializer' => 'getSpraySerializerService',
            'spray_serializer.datetime_serializer' => 'getSpraySerializer_DatetimeSerializerService',
            'spray_serializer.datetimeimmutable_serializer' => 'getSpraySerializer_DatetimeimmutableSerializerService',
            'spray_serializer.generator' => 'getSpraySerializer_GeneratorService',
            'spray_serializer.integration.broadway' => 'getSpraySerializer_Integration_BroadwayService',
            'spray_serializer.listener.object' => 'getSpraySerializer_Listener_ObjectService',
            'spray_serializer.listener.object_type' => 'getSpraySerializer_Listener_ObjectTypeService',
            'spray_serializer.property_info' => 'getSpraySerializer_PropertyInfoService',
            'spray_serializer.serializer_cache' => 'getSpraySerializer_SerializerCacheService',
            'spray_serializer.serializer_locator' => 'getSpraySerializer_SerializerLocatorService',
            'spray_serializer.serializer_registry' => 'getSpraySerializer_SerializerRegistryService',
            'spray_serializer.stdclass_serializer' => 'getSpraySerializer_StdclassSerializerService',
            'spray_serializer_simple' => 'getSpraySerializerSimpleService',
        ...
        $this->aliases = array(
            'broadway.command_handling.command_bus' => 'broadway.command_handling.simple_command_bus',
            'broadway.event_store' => 'broadway.event_store.dbal',
            'broadway.event_store.dbal.connection' => 'doctrine.dbal.default_connection',
            'broadway.read_model.repository_factory' => 'broadway.read_model.elasticsearch.repository_factory',
            'broadway.saga.state.repository' => 'broadway.saga.state.mongodb_repository',
            'broadway.serializer.metadata' => 'spray_serializer.integration.broadway',
            ...
            'publisher_factory' => 'simgroep_event_sourcing.messaging.publisher_factory',
    ...
    /**
     * Gets the 'broadway.command_handling.simple_command_bus' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Broadway\CommandHandling\SimpleCommandBus A Broadway\CommandHandling\SimpleCommandBus instance.
     */
    protected function getBroadway_CommandHandling_SimpleCommandBusService()
    {
        $this->services['broadway.command_handling.simple_command_bus'] = $instance = new \Broadway\CommandHandling\SimpleCommandBus();

        $instance->subscribe($this->get('hangman.controller.command_handler'));

        return $instance;
    }

    /**
     * Gets the 'broadway.elasticsearch.client' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Elasticsearch\Client A Elasticsearch\Client instance.
     */
    protected function getBroadway_Elasticsearch_ClientService()
    {
        return $this->services['broadway.elasticsearch.client'] = new \Elasticsearch\Client(array('hosts' => array(0 => 'localhost:9200')));
    }

    /**
     * Gets the 'broadway.event_dispatcher' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Broadway\EventDispatcher\EventDispatcher A Broadway\EventDispatcher\EventDispatcher instance.
     */
    protected function getBroadway_EventDispatcherService()
    {
        $this->services['broadway.event_dispatcher'] = $instance = new \Broadway\EventDispatcher\EventDispatcher();

        $instance->addListener('broadway.saga.post_handle', array(0 => $this->get('broadway.saga.metadata_enricher'), 1 => 'postHandleSaga'));

        return $instance;
    }

    /**
     * Gets the 'broadway.event_handling.event_bus' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     *
     * @return \Broadway\EventHandling\SimpleEventBus A Broadway\EventHandling\SimpleEventBus instance.
     */
    protected function getBroadway_EventHandling_EventBusService($lazyLoad = true)
    {
        $this->services['broadway.event_handling.event_bus'] = $instance = new \Broadway\EventHandling\SimpleEventBus();

        $instance->subscribe($this->get('hangman.read_model.projector.game_statics'));
        $instance->subscribe($this->get('hangman.read_model.projector.game'));

        return $instance;
    }

    /**
     * Gets the 'broadway.event_store.dbal' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Broadway\EventStore\DBALEventStore A Broadway\EventStore\DBALEventStore instance.
     */
    protected function getBroadway_EventStore_DbalService()
    {
        $a = $this->get('spray_serializer.integration.broadway');

        return $this->services['broadway.event_store.dbal'] = new \Broadway\EventStore\DBALEventStore($this->get('doctrine.dbal.default_connection'), $a, $a, 'events', false);
    }

    /**
     * Gets the 'broadway.event_store.in_memory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Broadway\EventStore\InMemoryEventStore A Broadway\EventStore\InMemoryEventStore instance.
     */
    protected function getBroadway_EventStore_InMemoryService()
    {
        return $this->services['broadway.event_store.in_memory'] = new \Broadway\EventStore\InMemoryEventStore();
    }

    /**
     * Gets the 'broadway.metadata_enricher.console' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Broadway\Bundle\BroadwayBundle\Command\CommandMetadataEnricher A Broadway\Bundle\BroadwayBundle\Command\CommandMetadataEnricher instance.
     */
    protected function getBroadway_MetadataEnricher_ConsoleService()
    {
        return $this->services['broadway.metadata_enricher.console'] = new \Broadway\Bundle\BroadwayBundle\Command\CommandMetadataEnricher();
    }

    /**
     * Gets the 'broadway.metadata_enriching_event_stream_decorator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Broadway\EventSourcing\MetadataEnrichment\MetadataEnrichingEventStreamDecorator A Broadway\EventSourcing\MetadataEnrichment\MetadataEnrichingEventStreamDecorator instance.
     */
    protected function getBroadway_MetadataEnrichingEventStreamDecoratorService()
    {
        $this->services['broadway.metadata_enriching_event_stream_decorator'] = $instance = new \Broadway\EventSourcing\MetadataEnrichment\MetadataEnrichingEventStreamDecorator();

        $instance->registerEnricher($this->get('broadway.metadata_enricher.console'));
        $instance->registerEnricher($this->get('broadway.saga.metadata_enricher'));

        return $instance;
    }

    /**
     * Gets the 'broadway.read_model.elasticsearch.repository_factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Broadway\ReadModel\ElasticSearch\ElasticSearchRepositoryFactory A Broadway\ReadModel\ElasticSearch\ElasticSearchRepositoryFactory instance.
     */
    protected function getBroadway_ReadModel_Elasticsearch_RepositoryFactoryService()
    {
        return $this->services['broadway.read_model.elasticsearch.repository_factory'] = new \Broadway\ReadModel\ElasticSearch\ElasticSearchRepositoryFactory($this->get('broadway.elasticsearch.client'), $this->get('spray_serializer.integration.broadway'));
    }

    /**
     * Gets the 'broadway.saga.metadata.factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Broadway\Saga\Metadata\StaticallyConfiguredSagaMetadataFactory A Broadway\Saga\Metadata\StaticallyConfiguredSagaMetadataFactory instance.
     */
    protected function getBroadway_Saga_Metadata_FactoryService()
    {
        return $this->services['broadway.saga.metadata.factory'] = new \Broadway\Saga\Metadata\StaticallyConfiguredSagaMetadataFactory();
    }

    /**
     * Gets the 'broadway.saga.metadata_enricher' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Broadway\Saga\SagaMetadataEnricher A Broadway\Saga\SagaMetadataEnricher instance.
     */
    protected function getBroadway_Saga_MetadataEnricherService()
    {
        return $this->services['broadway.saga.metadata_enricher'] = new \Broadway\Saga\SagaMetadataEnricher();
    }

    /**
     * Gets the 'broadway.saga.multiple_saga_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Broadway\Saga\MultipleSagaManager A Broadway\Saga\MultipleSagaManager instance.
     */
    protected function getBroadway_Saga_MultipleSagaManagerService()
    {
        return $this->services['broadway.saga.multiple_saga_manager'] = new \Broadway\Saga\MultipleSagaManager($this->get('broadway.saga.state.mongodb_repository'), array(), $this->get('broadway.saga.state.state_manager'), $this->get('broadway.saga.metadata.factory'), $this->get('broadway.event_dispatcher'));
    }

    /**
     * Gets the 'broadway.saga.state.mongodb_collection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\MongoDB\Collection A Doctrine\MongoDB\Collection instance.
     */
    protected function getBroadway_Saga_State_MongodbCollectionService()
    {
        return $this->services['broadway.saga.state.mongodb_collection'] = $this->get('broadway.saga.state.mongodb_database')->createCollection('saga-state');
    }

    /**
     * Gets the 'broadway.saga.state.mongodb_connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getBroadway_Saga_State_MongodbConnectionService()
    {
        return $this->services['broadway.saga.state.mongodb_connection'] = new \Doctrine\MongoDB\Connection(NULL, array());
    }

    /**
     * Gets the 'broadway.saga.state.mongodb_database' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\MongoDB\Database A Doctrine\MongoDB\Database instance.
     */
    protected function getBroadway_Saga_State_MongodbDatabaseService()
    {
        return $this->services['broadway.saga.state.mongodb_database'] = $this->get('broadway.saga.state.mongodb_connection')->selectDatabase('broadway_dev_dev');
    }

    /**
     * Gets the 'broadway.saga.state.mongodb_repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Broadway\Saga\State\MongoDBRepository A Broadway\Saga\State\MongoDBRepository instance.
     */
    protected function getBroadway_Saga_State_MongodbRepositoryService()
    {
        return $this->services['broadway.saga.state.mongodb_repository'] = new \Broadway\Saga\State\MongoDBRepository($this->get('broadway.saga.state.mongodb_collection'));
    }

    /**
     * Gets the 'broadway.saga.state.state_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Broadway\Saga\State\StateManager A Broadway\Saga\State\StateManager instance.
     */
    protected function getBroadway_Saga_State_StateManagerService()
    {
        return $this->services['broadway.saga.state.state_manager'] = new \Broadway\Saga\State\StateManager($this->get('broadway.saga.state.mongodb_repository'), $this->get('broadway.uuid.generator'));
    }

    /**
     * Gets the 'broadway.uuid.generator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Broadway\UuidGenerator\Rfc4122\Version4Generator A Broadway\UuidGenerator\Rfc4122\Version4Generator instance.
     */
    protected function getBroadway_Uuid_GeneratorService()
    {
        return $this->services['broadway.uuid.generator'] = new \Broadway\UuidGenerator\Rfc4122\Version4Generator();
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('console.command', array(0 => 'broadway.metadata_enricher.console', 1 => 'handleConsoleCommandEvent'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'hangman', 'user' => 'lennard', 'password' => 'geheim', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/HangmanBundle/Game/Infrastructure/Doctrine') => 'HangmanBundle'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'HangmanBundle');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('HangmanApplication' => 'HangmanBundle'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d2f1c12e6840bddcea2c8476ee32e5b9be16708880c644aaff8361a2b8eb5957');
    ...
    /**
     * Gets the 'hangman.controller.command_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HangmanBundle\Game\Application\GameCommandHandler A HangmanBundle\Game\Application\GameCommandHandler instance.
     */
    protected function getHangman_Controller_CommandHandlerService()
    {
        return $this->services['hangman.controller.command_handler'] = new \HangmanBundle\Game\Application\GameCommandHandler($this->get('hangman.repository.game'));
    }

    /**
     * Gets the 'hangman.controller.game' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HangmanBundle\Controller\DefaultController A HangmanBundle\Controller\DefaultController instance.
     */
    protected function getHangman_Controller_GameService()
    {
        return $this->services['hangman.controller.game'] = new \HangmanBundle\Controller\DefaultController($this->get('broadway.command_handling.simple_command_bus'), $this->get('broadway.uuid.generator'), $this->get('form.factory'), $this->get('router'), $this->get('hangman.read_model_game_repository'));
    }

    /**
     * Gets the 'hangman.controller.games_statics' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HangmanBundle\Controller\GamesStaticsController A HangmanBundle\Controller\GamesStaticsController instance.
     */
    protected function getHangman_Controller_GamesStaticsService()
    {
        return $this->services['hangman.controller.games_statics'] = new \HangmanBundle\Controller\GamesStaticsController($this->get('broadway.command_handling.simple_command_bus'), $this->get('broadway.uuid.generator'), $this->get('form.factory'), $this->get('router'), $this->get('hangman.read_model_game_statics_repository'), 'HangmanBundle:Game\\ReadModel\\GameStarted');
    }

    /**
     * Gets the 'hangman.read_model.projector.game' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HangmanBundle\Game\ReadModel\GameProjector A HangmanBundle\Game\ReadModel\GameProjector instance.
     */
    protected function getHangman_ReadModel_Projector_GameService()
    {
        return $this->services['hangman.read_model.projector.game'] = new \HangmanBundle\Game\ReadModel\GameProjector($this->get('hangman.read_model_game_repository'));
    }

    /**
     * Gets the 'hangman.read_model.projector.game_statics' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HangmanBundle\Game\ReadModel\GameStaticsProjector A HangmanBundle\Game\ReadModel\GameStaticsProjector instance.
     */
    protected function getHangman_ReadModel_Projector_GameStaticsService()
    {
        return $this->services['hangman.read_model.projector.game_statics'] = new \HangmanBundle\Game\ReadModel\GameStaticsProjector($this->get('hangman.read_model_game_statics_repository'));
    }

    /**
     * Gets the 'hangman.read_model_game_repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HangmanBundle\Game\ReadModel\Doctrine\DoctrineRepository A HangmanBundle\Game\ReadModel\Doctrine\DoctrineRepository instance.
     */
    protected function getHangman_ReadModelGameRepositoryService()
    {
        return $this->services['hangman.read_model_game_repository'] = new \HangmanBundle\Game\ReadModel\Doctrine\DoctrineRepository($this->get('doctrine.orm.default_entity_manager'), 'HangmanBundle\\Game\\ReadModel\\Game');
    }

    /**
     * Gets the 'hangman.read_model_game_statics_repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HangmanBundle\Game\ReadModel\Doctrine\DoctrineRepository A HangmanBundle\Game\ReadModel\Doctrine\DoctrineRepository instance.
     */
    protected function getHangman_ReadModelGameStaticsRepositoryService()
    {
        return $this->services['hangman.read_model_game_statics_repository'] = new \HangmanBundle\Game\ReadModel\Doctrine\DoctrineRepository($this->get('doctrine.orm.default_entity_manager'), 'HangmanBundle\\Game\\ReadModel\\GameStatics');
    }

    /**
     * Gets the 'hangman.repository.game' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HangmanBundle\Game\Domain\Game\GameRepository A HangmanBundle\Game\Domain\Game\GameRepository instance.
     */
    protected function getHangman_Repository_GameService()
    {
        return $this->services['hangman.repository.game'] = new \HangmanBundle\Game\Domain\Game\GameRepository($this->get('broadway.event_store.dbal'), $this->get('broadway.event_handling.event_bus'), array(0 => $this->get('broadway.metadata_enriching_event_stream_decorator')));
    }

    /**
     * Gets the 'hangman.services.messages' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HangmanBundle\Services\MessagesService A HangmanBundle\Services\MessagesService instance.
     */
    protected function getHangman_Services_MessagesService()
    {
        return $this->services['hangman.services.messages'] = new \HangmanBundle\Services\MessagesService();
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'Broadway\\Bundle\\BroadwayBundle' => ($this->targetDirs[3].'/vendor/broadway/broadway/src/Broadway/Bundle/BroadwayBundle/Resources/config/serializer'), 'Simgroep\\EventSourcing\\EventSourcingBundle' => ($this->targetDirs[3].'/vendor/simgroep/event-sourcing/src/EventSourcingBundle/Resources/config/serializer'), 'HangmanBundle' => ($this->targetDirs[3].'/src/HangmanBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'Spray\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jurjean/spray-serializer-bundle/src/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/FOS/RestBundle/Resources/config/serializer'), 'Bazinga\\Bundle\\FakerBundle' => ($this->targetDirs[3].'/vendor/willdurand/faker-bundle/Bazinga/Bundle/FakerBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\FixturesBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-fixtures-bundle/Resources/config/serializer'), 'Liip\\FunctionalTestBundle' => ($this->targetDirs[3].'/vendor/liip/functional-test-bundle/Resources/config/serializer')));
    ...
    /**
     * Gets the 'sim.event_store.replay' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Simgroep\EventSourcing\EventSourcingBundle\Infrastructure\Replay A Simgroep\EventSourcing\EventSourcingBundle\Infrastructure\Replay instance.
     */
    protected function getSim_EventStore_ReplayService()
    {
        $a = $this->get('spray_serializer.integration.broadway');

        return $this->services['sim.event_store.replay'] = new \Simgroep\EventSourcing\EventSourcingBundle\Infrastructure\Replay($this->get('doctrine.dbal.default_connection'), $a, $a, 'events');
    }

    /**
     * Gets the 'sim.projector.registry' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Simgroep\EventSourcing\EventSourcingBundle\ProjectorRegistry\ProjectorRegistry A Simgroep\EventSourcing\EventSourcingBundle\ProjectorRegistry\ProjectorRegistry instance.
     */
    protected function getSim_Projector_RegistryService()
    {
        ...
        $instance->addProjector($this->get('hangman.read_model.projector.game_statics'), 'hangman.read_model.projector.game_statics', $this->get('hangman.read_model_game_statics_repository'));
        $instance->addProjector($this->get('hangman.read_model.projector.game'), 'hangman.read_model.projector.game', $this->get('hangman.read_model_game_repository'));

        return $instance;
    }

    /**
     * Gets the 'sim.read_model.repository.game' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HangmanBundle\Game\ReadModel\Doctrine\DoctrineRepository A HangmanBundle\Game\ReadModel\Doctrine\DoctrineRepository instance.
     */
    protected function getSim_ReadModel_Repository_GameService()
    {
        return $this->services['sim.read_model.repository.game'] = new \HangmanBundle\Game\ReadModel\Doctrine\DoctrineRepository($this->get('doctrine.orm.default_entity_manager'), 'HangmanApplication:Game\\Domain\\Config\\GameStarted');
    }

    /**
     * Gets the 'simgroep.event_sourcing.command.container' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CommandContainer A CommandContainer instance.
     */
    protected function getSimgroep_EventSourcing_Command_ContainerService()
    {
        return $this->services['simgroep.event_sourcing.command.container'] = $this->get('simgroep.event_sourcing.command.locator')->locate(NULL, NULL);
    }

    /**
     * Gets the 'simgroep.event_sourcing.command.factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Simgroep\EventSourcing\CommandHandling\CommandFactory A Simgroep\EventSourcing\CommandHandling\CommandFactory instance.
     */
    protected function getSimgroep_EventSourcing_Command_FactoryService()
    {
        return $this->services['simgroep.event_sourcing.command.factory'] = new \Simgroep\EventSourcing\CommandHandling\CommandFactory($this->get('simgroep.event_sourcing.command.container'), $this->get('liip_functional_test.validator'));
    }

    /**
     * Gets the 'simgroep.event_sourcing.command.locator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Simgroep\EventSourcing\CommandHandling\CommandLocator A Simgroep\EventSourcing\CommandHandling\CommandLocator instance.
     */
    protected function getSimgroep_EventSourcing_Command_LocatorService()
    {
        return $this->services['simgroep.event_sourcing.command.locator'] = new \Simgroep\EventSourcing\CommandHandling\CommandLocator();
    }

    /**
     * Gets the 'simgroep_event_sourcing.command_gateway' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Simgroep\EventSourcing\CommandHandling\CommandGateway A Simgroep\EventSourcing\CommandHandling\CommandGateway instance.
     */
    protected function getSimgroepEventSourcing_CommandGatewayService()
    {
        return $this->services['simgroep_event_sourcing.command_gateway'] = new \Simgroep\EventSourcing\CommandHandling\CommandGateway($this->get('broadway.command_handling.simple_command_bus'), $this->get('simgroep_event_sourcing.command_gateway.scheduler'));
    }

    /**
     * Gets the 'simgroep_event_sourcing.command_gateway.scheduler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Simgroep\EventSourcing\CommandHandling\IntervalScheduler A Simgroep\EventSourcing\CommandHandling\IntervalScheduler instance.
     */
    protected function getSimgroepEventSourcing_CommandGateway_SchedulerService()
    {
        return $this->services['simgroep_event_sourcing.command_gateway.scheduler'] = new \Simgroep\EventSourcing\CommandHandling\IntervalScheduler(50000, 100);
    }

    /**
     * Gets the 'simgroep_event_sourcing.event_loop_consumer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \React\EventLoop\LoopInterface A React\EventLoop\LoopInterface instance.
     */
    protected function getSimgroepEventSourcing_EventLoopConsumerService()
    {
        return $this->services['simgroep_event_sourcing.event_loop_consumer'] = \React\EventLoop\Factory::create();
    }

    /**
     * Gets the 'simgroep_event_sourcing.event_loop_publisher' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \React\EventLoop\LoopInterface A React\EventLoop\LoopInterface instance.
     */
    protected function getSimgroepEventSourcing_EventLoopPublisherService()
    {
        return $this->services['simgroep_event_sourcing.event_loop_publisher'] = \React\EventLoop\Factory::create();
    }

    /**
     * Gets the 'simgroep_event_sourcing.locking_repository_factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Simgroep\EventSourcing\Repository\LockingRepositoryFactory A Simgroep\EventSourcing\Repository\LockingRepositoryFactory instance.
     */
    protected function getSimgroepEventSourcing_LockingRepositoryFactoryService()
    {
        return $this->services['simgroep_event_sourcing.locking_repository_factory'] = new \Simgroep\EventSourcing\Repository\LockingRepositoryFactory($this->get('simgroep_event_sourcing.repository.lock_manager'), $this->get('broadway.event_store.dbal'), $this->get('broadway.event_handling.event_bus'), new \Broadway\EventSourcing\AggregateFactory\PublicConstructorAggregateFactory());
    }

    /**
     * Gets the 'simgroep_event_sourcing.messaging.consumer_channel_factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Simgroep\EventSourcing\Messaging\ChannelFactory A Simgroep\EventSourcing\Messaging\ChannelFactory instance.
     */
    protected function getSimgroepEventSourcing_Messaging_ConsumerChannelFactoryService()
    {
        return $this->services['simgroep_event_sourcing.messaging.consumer_channel_factory'] = new \Simgroep\EventSourcing\Messaging\ChannelFactory($this->get('spray_serializer'), $this->get('simgroep_event_sourcing.event_loop_consumer'), array('host' => 'localhost', 'port' => 5672, 'user' => 'guest', 'pass' => 'guest'));
    }

    /**
     * Gets the 'simgroep_event_sourcing.messaging.consumer_factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Simgroep\EventSourcing\Messaging\ConsumerFactory A Simgroep\EventSourcing\Messaging\ConsumerFactory instance.
     */
    protected function getSimgroepEventSourcing_Messaging_ConsumerFactoryService()
    {
        return $this->services['simgroep_event_sourcing.messaging.consumer_factory'] = new \Simgroep\EventSourcing\Messaging\ConsumerFactory($this->get('simgroep_event_sourcing.event_loop_consumer'), $this->get('simgroep_event_sourcing.messaging.consumer_channel_factory'), $this->get('spray_serializer'));
    }

    /**
     * Gets the 'simgroep_event_sourcing.messaging.publisher_channel_factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Simgroep\EventSourcing\Messaging\ChannelFactory A Simgroep\EventSourcing\Messaging\ChannelFactory instance.
     */
    protected function getSimgroepEventSourcing_Messaging_PublisherChannelFactoryService()
    {
        return $this->services['simgroep_event_sourcing.messaging.publisher_channel_factory'] = new \Simgroep\EventSourcing\Messaging\ChannelFactory($this->get('spray_serializer'), $this->get('simgroep_event_sourcing.event_loop_publisher'), array('host' => 'localhost', 'port' => 5672, 'user' => 'guest', 'pass' => 'guest'));
    }

    /**
     * Gets the 'simgroep_event_sourcing.messaging.publisher_factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Simgroep\EventSourcing\Messaging\PublisherFactory A Simgroep\EventSourcing\Messaging\PublisherFactory instance.
     */
    protected function getSimgroepEventSourcing_Messaging_PublisherFactoryService()
    {
        return $this->services['simgroep_event_sourcing.messaging.publisher_factory'] = new \Simgroep\EventSourcing\Messaging\PublisherFactory($this->get('simgroep_event_sourcing.event_loop_publisher'), $this->get('simgroep_event_sourcing.messaging.publisher_channel_factory'), $this->get('spray_serializer'));
    }

    /**
     * Gets the 'simgroep_event_sourcing.repository.lock_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Simgroep\EventSourcing\Repository\PessimisticLockManager A Simgroep\EventSourcing\Repository\PessimisticLockManager instance.
     */
    protected function getSimgroepEventSourcing_Repository_LockManagerService()
    {
        return $this->services['simgroep_event_sourcing.repository.lock_manager'] = new \Simgroep\EventSourcing\Repository\PessimisticLockManager(new \NinjaMutex\Lock\MySqlLock('lennard', 'geheim', '127.0.0.1'));
    }

    /**
     * Gets the 'simgroep_event_sourcing.serializer.domain_event_stream' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Simgroep\EventSourcing\EventSourcingBundle\Serializer\DomainEventStreamSerializer A Simgroep\EventSourcing\EventSourcingBundle\Serializer\DomainEventStreamSerializer instance.
     */
    protected function getSimgroepEventSourcing_Serializer_DomainEventStreamService()
    {
        return $this->services['simgroep_event_sourcing.serializer.domain_event_stream'] = new \Simgroep\EventSourcing\EventSourcingBundle\Serializer\DomainEventStreamSerializer();
    }

    /**
     * Gets the 'simgroep_event_sourcing.serializer.domain_message' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Simgroep\EventSourcing\EventSourcingBundle\Serializer\DomainMessageSerializer A Simgroep\EventSourcing\EventSourcingBundle\Serializer\DomainMessageSerializer instance.
     */
    protected function getSimgroepEventSourcing_Serializer_DomainMessageService()
    {
        return $this->services['simgroep_event_sourcing.serializer.domain_message'] = new \Simgroep\EventSourcing\EventSourcingBundle\Serializer\DomainMessageSerializer();
    }

    /**
     * Gets the 'spray_serializer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Spray\Serializer\Serializer A Spray\Serializer\Serializer instance.
     */
    protected function getSpraySerializerService()
    {
        $this->services['spray_serializer'] = $instance = new \Spray\Serializer\Serializer(new \Zend\EventManager\EventManager());

        $instance->attach($this->get('spray_serializer.listener.object_type'));
        $instance->attach($this->get('spray_serializer.listener.object'));

        return $instance;
    }

    /**
     * Gets the 'spray_serializer.datetime_serializer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Spray\Serializer\Object\DateTimeSerializer A Spray\Serializer\Object\DateTimeSerializer instance.
     */
    protected function getSpraySerializer_DatetimeSerializerService()
    {
        return $this->services['spray_serializer.datetime_serializer'] = new \Spray\Serializer\Object\DateTimeSerializer();
    }

    /**
     * Gets the 'spray_serializer.datetimeimmutable_serializer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Spray\Serializer\Object\DateTimeImmutableSerializer A Spray\Serializer\Object\DateTimeImmutableSerializer instance.
     */
    protected function getSpraySerializer_DatetimeimmutableSerializerService()
    {
        return $this->services['spray_serializer.datetimeimmutable_serializer'] = new \Spray\Serializer\Object\DateTimeImmutableSerializer();
    }

    /**
     * Gets the 'spray_serializer.generator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Spray\Serializer\Object\ObjectSerializerGenerator A Spray\Serializer\Object\ObjectSerializerGenerator instance.
     */
    protected function getSpraySerializer_GeneratorService()
    {
        return $this->services['spray_serializer.generator'] = new \Spray\Serializer\Object\ObjectSerializerGenerator($this->get('spray_serializer.property_info'));
    }

    /**
     * Gets the 'spray_serializer.integration.broadway' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Spray\SerializerBundle\Integration\BroadwaySerializer A Spray\SerializerBundle\Integration\BroadwaySerializer instance.
     */
    protected function getSpraySerializer_Integration_BroadwayService()
    {
        return $this->services['spray_serializer.integration.broadway'] = new \Spray\SerializerBundle\Integration\BroadwaySerializer($this->get('spray_serializer'));
    }

    /**
     * Gets the 'spray_serializer.listener.object' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Spray\Serializer\ObjectListener A Spray\Serializer\ObjectListener instance.
     */
    protected function getSpraySerializer_Listener_ObjectService()
    {
        return $this->services['spray_serializer.listener.object'] = new \Spray\Serializer\ObjectListener($this->get('spray_serializer.serializer_locator'));
    }

    /**
     * Gets the 'spray_serializer.listener.object_type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Spray\Serializer\ObjectTypeListener A Spray\Serializer\ObjectTypeListener instance.
     */
    protected function getSpraySerializer_Listener_ObjectTypeService()
    {
        return $this->services['spray_serializer.listener.object_type'] = new \Spray\Serializer\ObjectTypeListener();
    }

    /**
     * Gets the 'spray_serializer.property_info' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Spray\Serializer\AnnotationBackedPropertyInfo A Spray\Serializer\AnnotationBackedPropertyInfo instance.
     */
    protected function getSpraySerializer_PropertyInfoService()
    {
        return $this->services['spray_serializer.property_info'] = new \Spray\Serializer\AnnotationBackedPropertyInfo();
    }

    /**
     * Gets the 'spray_serializer.serializer_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Spray\Serializer\Cache\FileCache A Spray\Serializer\Cache\FileCache instance.
     */
    protected function getSpraySerializer_SerializerCacheService()
    {
        return $this->services['spray_serializer.serializer_cache'] = new \Spray\Serializer\Cache\FileCache(new \Symfony\Component\Filesystem\Filesystem(), (__DIR__.'/spray-serializer'), 'Serializer');
    }

    /**
     * Gets the 'spray_serializer.serializer_locator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Spray\Serializer\Object\SerializerLocator A Spray\Serializer\Object\SerializerLocator instance.
     */
    protected function getSpraySerializer_SerializerLocatorService()
    {
        return $this->services['spray_serializer.serializer_locator'] = new \Spray\Serializer\Object\SerializerLocator($this->get('spray_serializer.serializer_registry'), $this->get('spray_serializer.generator'), $this->get('spray_serializer.serializer_cache'));
    }

    /**
     * Gets the 'spray_serializer.serializer_registry' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Spray\Serializer\Object\SerializerRegistry A Spray\Serializer\Object\SerializerRegistry instance.
     */
    protected function getSpraySerializer_SerializerRegistryService()
    {
        $this->services['spray_serializer.serializer_registry'] = $instance = new \Spray\Serializer\Object\SerializerRegistry();

        $instance->add($this->get('simgroep_event_sourcing.serializer.domain_message'));
        $instance->add($this->get('simgroep_event_sourcing.serializer.domain_event_stream'));
        $instance->add($this->get('spray_serializer.stdclass_serializer'));
        $instance->add($this->get('spray_serializer.datetime_serializer'));
        $instance->add($this->get('spray_serializer.datetimeimmutable_serializer'));

        return $instance;
    }

    /**
     * Gets the 'spray_serializer.stdclass_serializer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Spray\Serializer\Object\StdClassSerializer A Spray\Serializer\Object\StdClassSerializer instance.
     */
    protected function getSpraySerializer_StdclassSerializerService()
    {
        return $this->services['spray_serializer.stdclass_serializer'] = new \Spray\Serializer\Object\StdClassSerializer();
    }

    /**
     * Gets the 'spray_serializer_simple' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Spray\Serializer\Serializer A Spray\Serializer\Serializer instance.
     */
    protected function getSpraySerializerSimpleService()
    {
        $this->services['spray_serializer_simple'] = $instance = new \Spray\Serializer\Serializer(new \Zend\EventManager\EventManager());
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/HangmanBundle/Resources/views'), 'Hangman');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56a0d92016d433.34732497')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SimgroepEventSourcingBundle' => 'Simgroep\\EventSourcing\\EventSourcingBundle\\SimgroepEventSourcingBundle',
                'HangmanBundle' => 'HangmanBundle\\HangmanBundle',
            ...
            'broadway.saga.mongodb.storage_suffix' => '_dev',
            'broadway.saga.mongodb.database' => 'broadway_dev_dev',
            'broadway.event_store.dbal.connection' => 'default',
            'broadway.event_store.dbal.table' => 'events',
